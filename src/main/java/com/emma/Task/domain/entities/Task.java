...
@Table(name="task")
public class Task {
//    defining the entities in the task table
    @Id
    ...
    @Column(name="due_date") // by ommiting nullable ad updatable the default value is set to true
...
//    relation btn Task and Task list
    @ManyToOne(fetch =FetchType.LAZY) // Lazy means task will be loaded oly when its query
    @JoinColumn(name="task_list_id") // column name of the foreign key
...
//    creating another class constructor with all the params
